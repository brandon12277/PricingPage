...
const FaceBookAds = () =>{
    ...
    const pricingPlans = [
        { name: "Premium", price: "₹ 8999/-",color : "text-green-500",bg : "bg-green-500" },
        { name: "Elite", price: "₹ 12999/-",color : "text-blue-500",bg : "bg-blue-500" },
        { name: "Pro Plan", price: "₹ 19999/-",color : "text-red-500",bg : "bg-red-500" },
     ...
     return(
        ...
        <>
        <div className="flex mt-40 flex-col gap-2 items-center justify-center">

            <h1 className="text-3xl mb-4 font-bold roboto">FACEBOOK ADS PLANS</h1>
